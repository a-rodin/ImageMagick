          ...
          switch (metric)
          {
            ...
            case PeakAbsoluteErrorMetric:
            {
              switch (image->colorspace)
              {
                ...
                default:
                {
                  (void) fprintf(stderr,"    red: %g (%g)\n",
                    channel_distortion[RedChannel],(double) QuantumScale*
                    channel_distortion[RedChannel]);
                  (void) fprintf(stderr,"    green: %g (%g)\n",
                    channel_distortion[GreenChannel],(double) QuantumScale*
                    channel_distortion[GreenChannel]);
                  (void) fprintf(stderr,"    blue: %g (%g)\n",
                    channel_distortion[BlueChannel],(double) QuantumScale*
                    channel_distortion[BlueChannel]);
                  if (image->matte != MagickFalse)
                    (void) fprintf(stderr,"    alpha: %g (%g)\n",
                      channel_distortion[OpacityChannel],(double) QuantumScale*
                ...
                case CMYKColorspace:
                {
                  (void) fprintf(stderr,"    cyan: %g (%g)\n",
                    channel_distortion[CyanChannel],(double) QuantumScale*
                    channel_distortion[CyanChannel]);
                  (void) fprintf(stderr,"    magenta: %g (%g)\n",
                    channel_distortion[MagentaChannel],(double) QuantumScale*
                    channel_distortion[MagentaChannel]);
                  (void) fprintf(stderr,"    yellow: %g (%g)\n",
                    channel_distortion[YellowChannel],(double) QuantumScale*
                    channel_distortion[YellowChannel]);
                  (void) fprintf(stderr,"    black: %g (%g)\n",
                    channel_distortion[BlackChannel],(double) QuantumScale*
                ...
                case GRAYColorspace:
                {
                  (void) fprintf(stderr,"    gray: %g (%g)\n",
                    channel_distortion[GrayChannel],(double) QuantumScale*
              ...
              (void) fprintf(stderr,"    all: %g (%g)\n",
                channel_distortion[AllChannels],(double) QuantumScale*
