...
Magick::ImageType Magick::Image::type ( void )
{
  ...
  if ( image_type == UndefinedType )
    image_type= GetImageType( image(), &exceptionInfo);
  throwException( exceptionInfo );
  (void) DestroyExceptionInfo( &exceptionInfo );
  return image_type;
}
                                 ...
                                 const unsigned char *source_ )
{
  ...
  ExceptionInfo exceptionInfo;
  GetExceptionInfo( &exceptionInfo );
  ImportQuantumPixels(image(),(MagickCore::ViewInfo *) NULL,quantum_info,
                                  ...
                                  unsigned char *destination_ )
{
  ...
  ExceptionInfo exceptionInfo;
  GetExceptionInfo( &exceptionInfo );
  ExportQuantumPixels(image(),(MagickCore::ViewInfo *) NULL,quantum_info,
