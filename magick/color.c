...
%
*/
MagickExport MagickBooleanType IsGrayImage(Image *image,
  ExceptionInfo *exception)
{
  ImageType
    type;
...
%
*/
MagickExport MagickBooleanType IsMonochromeImage(Image *image,
  ExceptionInfo *exception)
{
  ImageType
    type;
  ...
  if (*name == '#')
    {
      ...
      */
      ...
      color->red=(MagickRealType) ScaleAnyToQuantum(pixel.red,depth,scale);
      color->green=(MagickRealType) ScaleAnyToQuantum(pixel.green,depth,scale);
      color->blue=(MagickRealType) ScaleAnyToQuantum(pixel.blue,depth,scale);
