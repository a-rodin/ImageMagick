...
#include <pthread.h>
#endif
#if defined(MAGICKCORE_HAVE_LINUX_UNISTD_H)
...
{
#if defined(MAGICKCORE_HAVE_PTHREAD) && defined(MAGICKCORE_HAVE_LINUX_UNISTD_H)
  return((unsigned long) ((pid_t) syscall(__NR_gettid)));
#endif
#if defined(__WINDOWS__)
